...
const Card = ({hotel}) => {
    return(
        <div className={'flex relative flex-col font-primary text-default h-[300px]'}>
            ...
            <Link to={location => `${location.pathname}/${hotel.id}`} className={'absolute w-[150px] text-center top-0 left-0 p-4 rounded-br-[10px] rounded-tl-[10px] bg-secondary text-small text-white'}>Подробнее</Link>
