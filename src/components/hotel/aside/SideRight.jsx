...
const SideRight = () => {
    ...
    return(
        <div className={`absolute font-primary p-[55px] rounded text-white flex flex-col font-primary gap-[10px] right-0 top-0 w-[33%] h-[90vh] overflow-y-scroll  bg-secondary transition duration-500 ease-in-out`}>
